...
export class Backend implements backendInterface {
    ...
    async addItem(arg0: string, arg1: bigint, arg2: string): Promise<ItemId> {
        if (this.processError) {
            try {
                const result = await this.actor.addItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async clearAllItems(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearAllItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async clearCheckedItems(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearCheckedItems();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async markItemChecked(arg0: ItemId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.markItemChecked(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleItemChecked(arg0: ItemId): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleItemChecked(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
